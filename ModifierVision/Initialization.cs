...
namespace ModifierVision
{
    internal class Initialization
    {
        public Initialization()
        {
            ...
            settings.AddItem(new MenuItem("Settings.TextSize", "Text Size").SetValue(new Slider(100, 10, 100)));
            settings.AddItem(new MenuItem("ExtraPos.X", "Extra Position X").SetValue(new Slider(75, -200, 200)));
            settings.AddItem(new MenuItem("ExtraPos.Y", "Extra Position Y").SetValue(new Slider(25, -200, 200)));
